...
class VaultManager:
    ...
    def eso_values(self, token):
        ...
        pg_user=self.kwargs.get('analyticsedge-rds-user')
        pg_host=self.kwargs.get('analyticsedge-rds-endpoint')
        pg_pass=self.kwargs.get('analyticsedge-rds-password')
...
if __name__ == "__main__":
    ...
    vault_manager = VaultManager(**secrets)
    vault_manager.main()
