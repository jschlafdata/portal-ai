...
const config = {
  ...
  organizationName: 'PrincipalCG', // Usually your GitHub org/user name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/jschlafdata/if-insurance-databricks',
            label: 'GitHub',
            position: 'right',
          },
          {
            href: 'https://adb-6739836370169955.15.azuredatabricks.net/',
            label: 'Databricks',
            position: 'right',
          },
        ],
